...
public class SetBalance extends Element {
    public SetBalance(UltraCustomizer ultraCustomizer) {
        super(ultraCustomizer);
    }

    @Override
    public String getName() {
        return "Set Balance (CoinsEngine)";
    }

    @Override
    public String getInternalName() {
        return "ce-set-balance";
    }
    ...
    public String[] getDescription() {
        return new String[]{"Set user balance for selected currency."};
    }
    ...
    public void run(ElementInfo elementInfo, ScriptInstance scriptInstance) {
        ...
        CoinsEngineAPI.setBalance(player, currency, balance);
