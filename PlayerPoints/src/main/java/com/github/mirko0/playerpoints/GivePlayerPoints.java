...
public class GivePlayerPoints extends Element {
    public GivePlayerPoints(UltraCustomizer plugin) {
        super(plugin);
    }

    @Override
    public String getName() {
        return "Give Player Points";
    }
    ...
    public String[] getDescription() {
        return new String[]{"Give the player some points."};
    }
    ...
    public void run(ElementInfo elementInfo, ScriptInstance scriptInstance) {
        ...
        api.give(player.getUniqueId(), (int) points);
