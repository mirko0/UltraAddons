...
public class ResetPlayerPoints extends Element {
    public ResetPlayerPoints(UltraCustomizer plugin) {
        super(plugin);
    }

    @Override
    public String getName() {
        return "Reset Player Points";
    }
    ...
    public String[] getDescription() {
        return new String[]{"Reset the player points."};
    }
