...
public class TakePlayerPoints extends Element {
    public TakePlayerPoints(UltraCustomizer plugin) {
        super(plugin);
    }

    @Override
    public String getName() {
        return "Take Player Points";
    }
    ...
    public String[] getDescription() {
        return new String[]{"Take some points from player."};
    }
    ...
    public void run(ElementInfo elementInfo, ScriptInstance scriptInstance) {
        ...
        api.take(player.getUniqueId(), (int) points);
